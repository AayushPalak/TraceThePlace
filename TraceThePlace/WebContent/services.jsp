					...
					<div class="simblaEL carouselHolder carouselHolderNew active main" data-drag="P0" id="P0">
						...
						<ol class="carousel-indicators" data-sortable-id="1" aria-dropeffect="move">
							...
							<div class="simblaEL tcH" frompage")"="" data-drag="P16" id="P16"><div class="textContainer H1" style="cursor: text; line-height: 48px;">
								...
								<font style="font-size: 48px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <font color="#ff7537">ATM&nbsp;</font></font></h1></div></div>
							...
							<div style="text-align: center;">Find Nearest ATM in one go</div></h2></div></div>
							<div class="btn-wrap simblaEL" style="text-align: center;">
								<a type="submit" class="simblaEL btn  btn-lg btn-info hvr-buzz" data-drag="P30" id="P30" style="position: relative; margin-top: 30px;" href="atm.jsp" bs-btn="">SEARCH</a></div></div></div></div></div></div>
							...
							<div style="text-align: center;">
								<font style="font-size: 48px;">Restaurants</font></div></h1></div></div>
							...
							<h2><div style="text-align: center;">Find Nearest Restaurants</div></h2></div></div>
							<div class="btn-wrap simblaEL" style="text-align: center;"><a type="submit" class="simblaEL btn  btn-lg btn-info hvr-buzz" data-drag="P30" id="P30" style="position: relative; margin-top: 30px;" href="restaurant.jsp" bs-btn="">Search</button></div></div></div></div></div></div></div>
