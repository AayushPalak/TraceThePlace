...
%>		
	...
	<form class="simblaEL" data-drag="P10"  method="POST" id="P10" action="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=dologin") %>" name="" data-failure="" data-failure-type="text" data-success="" data-success-type="text">
		...
		<div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column">
			...
			<div class="simblaEL form-group" data-drag="P16" id="P16">
				<label for="P15"></label><input type="text" class="form-control input-lg" name="email" id="P15" placeholder="Email"> </div>
			<div class="simblaEL form-group" data-drag="P20" id="P20">
				<label for="P19"></label>
				<input type="password" class="form-control input-lg" name="password" id="P19" placeholder="Password" required=""> </div>
				<button type="submit" class="simblaEL btn  btn-block btn-lg btn-info hvr-buzz" data-drag="P30" id="P30" style="position: relative; margin-top: 30px;" bs-btn="">LOGIN</button></div>
				<div class="sDivider col-md-4 index2" data-colsize="4" data-title="Column"></div></div>
	</form>
