...
<html>
	...
	<body data-spy="scroll" data-target=".navbar-collapse" class="">
		...
		<div class="sDivider col-md-4 index2" data-colsize="4" data-title="Column"></div></div>
			<form class="simblaEL" data-drag="P41"  method="POST" action="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=createaccount") %>" id="P41" name="" data-failure="" data-failure-type="text" data-success="" data-success-type="text">
			...
			<div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column">
				...
				<div class="simblaEL form-group" data-drag="P59" id="P59"><label for="P58"></label>
					...
					<button type="submit" class="simblaEL btn  btn-block btn-lg btn-info hvr-buzz" data-drag="P61" id="P61" style="position: relative; margin-top: 30px;"  bs-btn="">SIGN UP</button>
